...
class CustomTextInput extends Component {
    render() {
         const {
             label, labelStyle, maxLength, textInputStyle, stateHolder,stateFieldName } = this.props;
    return (
        <View>
            <Text style={ [ styles.fieldLabel, labelStyle ] }> </Text>
...
CustomTextInput.propTypes = {
    ...
    stateFieldName : PropTypes.object.isRequired,
};
...
const styles = StyleSheet.create({
    ...
    textInput : {
        height : 40, marginLeft : 10, width : "96%",
        marginBottom : 20, 
        ...Platform.select({
